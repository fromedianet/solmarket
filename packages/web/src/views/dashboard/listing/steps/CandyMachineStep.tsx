...
export const CandyMachineStep = ({collection, saving, handleAction}: {
  collection: {};
  saving: boolean;
  ...
  useEffect(() => {
    form.setFieldsValue({
      ...
      candymachine_ids: collection['candymachine_ids'].length > 0 ? collection['candymachine_ids'][0] : '',
      // datepicker: collection['launch_time'] && moment.unix(collection['launch_time'])
    })
  }, [collection]);

  const onFinish = values => {
    const params = {
      launch_time: values.datepicker.utc(),
  ...
  return (
    <div className='step-page'>
      ...
      <p className="label">
        Please input your candymachine Id for your NFTs.
      </p>
      <Form
        form={form}
        layout="vertical"
      ...
      >
        ...
        <Form.Item
          ...
          rules={[
            ...
            { pattern: new RegExp("^[a-zA-Z0-9]{44}$"), message: 'Format is wrong'}
          ]}
        >
          <Input
