            ...
            <div className='created-by-container'>
              ...
              <div className='created-by-content'>
                {(art.creators || []).map((creator, index) => (
                  <CopySpan key={index} value={shortenAddress(creator.address || '')} copyText={creator.address || ''} className='creator-address' />
                ))}
              </div>
            </div>
            <a href='' target='_blank' rel='noreferer' className='social-link' title='Twitter'>
